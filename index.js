...
myMusic.addEventListener("timeupdate",function(){
    ...
    if(document.getElementById(curTime)){
        ...
        document.getElementById(curTime).style.cssText = "background: linear-gradient(-3deg,#eebd89 0%, #d13abd 100%);-webkit-background-clip: text;color: transparent;font: 20px;";
